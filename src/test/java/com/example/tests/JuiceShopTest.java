...
//                .assertThat().statusCode(201);
    ...
    public void addProductToCart() {
        Authentication authentication = login("test845@gmail.com", "Password@123")
                .then()
                .assertThat().statusCode(200)
    ...
    private Response login(String email, String password) {
        ...
        return given().spec(requestSpecification)
                .contentType(ContentType.JSON)
                .body(loginBuilder(email, password))
    ...
    private LoginBuilder loginBuilder(String email, String password){
        return  LoginBuilder.builder().
                email(email).
                password(password).
                build();
    }
